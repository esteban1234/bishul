...
<article class="lineaarriba">
	<article class="lineadentro">
		<article class="contenpuntonsmas">
		<p class="puntoslineas">Eventos</>
		<p class="mas">+</p>
		</article>
		<article class="contenpuntonsmas">
		<p class="puntoslineas">Bodas</>
		<p class="mas">+</p>
		</article>
		<article class="contenpuntonsmas">
		<p class="puntoslineas">Gourmet</>
		<p class="mas">+</p>
		</article>
		<article class="contenpuntonsmas">
		<p class="puntoslineas">XV años</>
		<p class="mas">+</p>
		</article>
		<article class="contenpuntonsmas">
